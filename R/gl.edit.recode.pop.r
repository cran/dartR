...
#'
#' @param x Name of the genlight object for which populations are to be
#'  reassigned [required].
...
#' @param recalc Recalculate the locus metadata statistics if any individuals are deleted
#' [default TRUE].
