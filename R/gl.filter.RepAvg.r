...
gl.filter.RepAvg <- function(x, threshold=0.99, verbose=NULL) {

# TRAP COMMAND, SET VERSION
  cat("Warning: This function will be depracated in future versions. Use gl.filter.reproducibilty instead!!!")  
